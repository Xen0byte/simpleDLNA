...
namespace NMaier.SimpleDlna.Utilities
{
  public static class Formatting
  {
    ...
    {
      if (maybeBoolean == null) throw new ArgumentNullException(nameof(maybeBoolean));
    ...
    public static string FormatFileSize(this long size)
    {
      ...
      var ds = size / 1024.0;
      if (ds < 900) return $"{ds:F2} KB";
      ds /= 1024.0;
      if (ds < 900) return $"{ds:F2} MB";
      ds /= 1024.0;
      if (ds < 900) return $"{ds:F3} GB";
      ds /= 1024.0;
      if (ds < 900) return $"{ds:F3} TB";
      ds /= 1024.0;
      return $"{ds:F4} PB";
    }
    ...
    public static string GetSystemName()
    {
      ...
      if (SafeNativeMethods.uname(buf) != 0) throw new ArgumentException("Failed to get uname");
    ...
    public static string StemCompareBase(this string name)
    {
      ...
      var san = trimmore.Replace(
        ...
        string.Empty).Trim();
      if (string.IsNullOrWhiteSpace(san)) return name;
    ...
    public static string StemNameBase(this string name)
    {
      ...
      if (string.IsNullOrWhiteSpace(ws)) return name;
      return ws;
    }
  }
}
